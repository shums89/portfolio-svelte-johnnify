...
<footer class="footer mt-[5svh] items-center bg-neutral px-inline py-4 text-neutral-content">
	...
	<nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
		<ul class="flex gap-2">
			<li>
				<OutboundLink href="https://www.youtube.com/">
					<YouTube class="w-8" aria-label="YouTube" />
				</OutboundLink>
			</li>
			<li>
				<OutboundLink href="https://discord.gg/">
					<Discord class="w-8" aria-label="Discord" />
				</OutboundLink>
			</li>
			<li>
				<OutboundLink href="https://www.instagram.com/">
					<Instagram class="w-8" aria-label="Instagram" />
				</OutboundLink>
			</li>
		</ul>
	</nav>
